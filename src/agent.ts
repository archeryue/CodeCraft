...
import { TOOLS, executor, createToolContext } from './tool_setup.js';
...
import { detectProjectTypeTool } from './tools/detect_project_type.js';
import { extractConventionsTool } from './tools/extract_conventions.js';
import { getProjectOverviewTool } from './tools/get_project_overview.js';
  ...
  exit      - Quit the application`;
                case '/init':
                    try {
                        ...
                        // Format results
                        const projectType = this.formatToolResult(projectTypeResult);
                        const conventions = this.formatToolResult(conventionsResult);
                        const overview = this.formatToolResult(overviewResult);
