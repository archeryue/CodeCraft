...
describe('build_dependency_graph tool', () => {
    describe('Happy Path Tests', () => {
        ...
        it('should identify all exports for each file', async () => {
            ...
            const toolsNode = graph.nodes.find((n: any) => n.file.includes('tools.ts'));
    ...
    describe('Graph Structure Tests', () => {
        ...
        it('should support reverse lookup (file → what imports it)', async () => {
            ...
            const toolsImportedBy = graph.edges
                .filter((e: any) => e.to.includes('tools.ts'))
                .map((e: any) => e.from);
    ...
    describe('Edge Cases', () => {
        ...
        it('should return error for non-existent directory', async () => {
            const result = await executeTool('build_dependency_graph', { path: './nonexistent_dir_12345' });
